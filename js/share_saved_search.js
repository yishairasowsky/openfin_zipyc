...
taskRegistry["button1-click"] = async (event) => {
  ...
  let winOption = {
    ...
    defaultWidth: 300,
    defaultHeight: 300,
    url: window.location.origin + "/window_share_search.html",
    frame: true,
    autoShow: true
  };
...
const notification = {
  title: "Saved Search {Saved Search Name} has been shared with you",
  category: "Search",
  body:
    "Saved search “[search name]” has been shared with you - INCLUDE CLICKABLE LINK",
