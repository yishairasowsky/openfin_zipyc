...
taskRegistry["button1-click"] = async (event) => {
  ...
  let winOption = {
    ...
    defaultWidth: 300,
    defaultHeight: 300,
    url: window.location.origin + "/window_share_group_search.html",
    frame: true,
    autoShow: true
  };
...
const notification = {
  title: "Saved Search {Saved Search Name} has been shared with your group",
  category: "Search",
  body:
    "Saved search “[search name]” has been shared with your group “[group name]” - INCLUDE CLICKABLE LINK TO SAVED SEARCH",
