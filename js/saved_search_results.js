...
taskRegistry["button1-click"] = async (event) => {
  ...
  let winOption = {
    ...
    defaultWidth: 300,
    defaultHeight: 300,
    url: window.location.origin + "/window_search_results.html",
    frame: true,
    autoShow: true
  };
...
const notification = {
  title: "X new results for saved search {Saved Search Name}",
  category: "Search",
  body:
    "X new results found for saved search “[saved search name]” - INCLUDE CLICKABLE LINK",
